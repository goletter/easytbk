...
namespace Goletter\EasyTBK\vip\Osp\Exception;
...
// 	}
	...
	public function __construct($returnMessage, $returnCode=\Goletter\EasyTBK\vip\Osp\Exception\OspException::CALLEE_UNKNOWN_EXCEPTION) {
		$this->returnCode = $returnCode;
		$this->returnMessage = $returnMessage;
	}
