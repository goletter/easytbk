...
namespace Goletter\EasyTBK\vip\Osp\Log;
...
class Logger {
	...
	private static function init(){
		Logger::$LOG_PATH =  \Goletter\EasyTBK\vip\Osp\Util\PathUtil::getRootPath()."/osp-log/";
	...
	public static function error($msg, $e) {
		...
		if(Logger::$LOG_LEVEL <= Logger::$LOG_LEVEL_ERROR){
			if ($e instanceof \Goletter\EasyTBK\vip\Osp\Exception\OspException){
