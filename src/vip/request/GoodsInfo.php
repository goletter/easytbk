	...
	public function read($input){
		...
		while(true){
			...
			if ("storeInfo" == $schemeField){
				...
				$this->storeInfo = new \Goletter\EasyTBK\vip\request\StoreInfo();
			...
			if ("commentsInfo" == $schemeField){
				...
				$this->commentsInfo = new \Goletter\EasyTBK\vip\request\GoodsCommentsInfo();
			...
			if ("storeServiceCapability" == $schemeField){
				...
				$this->storeServiceCapability = new \Goletter\EasyTBK\vip\request\StoreServiceCapability();
			...
			if($needSkip){
				...
				\Goletter\EasyTBK\vip\Osp\Protocol\ProtocolUtil::skip($input);
			}
