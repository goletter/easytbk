...
class UnionGoodsServiceClient{
	...
	private static function regis(){
		...
		$path =  \Goletter\EasyTBK\vip\Osp\Util\PathUtil::getRootPath ();
		$nsLoader = new \Goletter\EasyTBK\vip\Osp\ClassLoader\ClassLoader ();
	...
	public static function getService(){
		...
		$ctx =  \Goletter\EasyTBK\vip\Osp\Context\InvocationContextFactory::getInstance ();
		...
		return new \Goletter\EasyTBK\vip\request\UnionGoodsServiceHelper();
	}
